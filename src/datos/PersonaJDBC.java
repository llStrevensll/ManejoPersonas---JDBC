...
public class PersonaJDBC {
    //Nos apoyamos de la llave primaria autoincrementable de MYsql por lo que se omite el campo persona_id
    //Se utiliza un prepareStatement, por lo que se puede utilizar parametros (signos de ?) 
